...
export default function NewStories(){
    ...
    <GridItem w='100%'> 
        <Card w="250px" h="395px" borderRadius="30" boxShadow="dark-lg" cursor="pointer"  as={motion.div} whileHover={{ rotateY: 180}} transition="120ms" transitionTimingFunction="ease-in-out">
